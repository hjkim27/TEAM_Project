...
개인정보 유지 기간을 선택하지 않으실 경우, 회원 정보는 회원 탈퇴시까지 유지됩니다. 또한 개인정보 유지 기간을 1년 혹은 2년으로 선택하실 경우, 해당 기간이 지나면 필수 입력 정보를 제외한 모든 회원 정보는 삭제됩니다. (필수를 제외한) 회원정보 삭제시에도 선택사항 미입력 시와 같이 아이디, 비밀번호 검색 등의 홈페이지 이용에 대한 제약이 있을 수 있습니다. 유지기간 종료 시 별도의 안내는 제공되지 않습니다.</textarea>
		</div>
	</div>
	<div>
			...
			<table class="regist-info">
				...
				<tbody>
					...
					<tr class="reg-need">
						...
						<td class="reg-need"><form:password path="passwordCheck" class="reg-info-label" /><form:errors path="passwordCheck" /></td>
					</tr>
					<tr class="reg-need">
						<td class="reg-need-label">* 이름</td>
						<td class="reg-need"><form:input path="name" class="reg-info-label" /><form:errors path="name" /></td>
					</tr>
					<tr class="reg-need">
						...
						<td class="reg-need">
							...
							<form:input path="phone2" class="reg-info-phone2" placeholder="'-' 를 제외한 8자리 숫자입력"/><form:errors path="phone2" />
						</td>
					</tr>				
				</tbody>
			</table>
			...
			<table class="regist-info">
				...
				<tbody>
					...
					<tr class="reg-need">
						...
						<td class="reg-need"><form:input path="addrSub" class="reg-info-label" placeholder="상세주소"/></td>
					</tr>
					<tr class="reg-need">
